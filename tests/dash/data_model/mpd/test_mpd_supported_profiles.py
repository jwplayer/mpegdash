...
class MPDSupportedDASHProfilesTest(unittest.TestCase):
    ...
    def test_mpd_model_with_degenerate_input(self):
        ...
        self.assertRaises(TypeError, MPD, minimum_buffer_time='')
        self.assertRaises(TypeError, MPD, profile='', minimum_buffer_time='')
        self.assertRaises(TypeError, MPD, profile=None, minimum_buffer_time=None)
        self.assertRaises(TypeError, MPD, profile='urn:mpeg:dash:profile:full:2011', minimum_buffer_time='')
        self.assertRaises(TypeError, MPD, profile='urn:mpeg:dash:profile:full:2011', minimum_buffer_time=0.0)
        self.assertRaises(TypeError, MPD, profile=0, minimum_buffer_time=0)
        self.assertRaises(TypeError, MPD, profile=0.0, minimum_buffer_time=0)
        self.assertRaises(TypeError, MPD, profile='', minimum_buffer_time=0)

    def test_mpd_model_with_supported_dash_profiles(self):
        self.assertRaises(TypeError, MPD, profile='urn:mpeg:dash:profile:full:2012', minimum_buffer_time=0)
        MPD(profile='urn:mpeg:dash:profile:full:2011', minimum_buffer_time=0)
        MPD(profile='urn:mpeg:dash:profile:isoff-on-demand:2011', minimum_buffer_time=0)
        MPD(profile='urn:mpeg:dash:profile:isoff-live:2011', minimum_buffer_time=0)
        MPD(profile='urn:mpeg:dash:profile:isoff-main:2011', minimum_buffer_time=0)
        MPD(profile='urn:mpeg:dash:profile:mp2t-main:2011', minimum_buffer_time=0)
        MPD(profile='urn:mpeg:dash:profile:mp2t-simple:2011', minimum_buffer_time=0)
        self.assertRaises(TypeError, MPD, profile='urn:3GPP:PSS:profile:DASH10', minimum_buffer_time=0)
